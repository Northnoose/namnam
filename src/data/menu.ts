...
export interface MenuItem {
  ...
  tags?: Array<"anbefalt" | "populær" | "sterk" | "vegetar">;
}
...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: 140,
        image: { src: "/img/menu/kebab_pita1.jpg", alt: "Kylling i pita" }, // bytt når du har kylling-bilde
      },
      {
        id: "grill-biff-pita",
        name: "Biff i pita",
        description: "Biff i pitabrød",
        price: 150,
        image: { src: "/img/menu/kebab_pita1.jpg", alt: "Biff i pita" }, // bytt når du har biff-bilde
      },
      {
        id: "grill-kebab-rull",
        name: "Kebab i rull",
      ...
      },
      {
        ...
        price: 140,
        image: { src: "/img/menu/kebabrull1.jpg", alt: "Kylling i rull" }, // bytt når du har kylling-bilde
      },
      {
        id: "grill-biff-rull",
        name: "Biff i rull",
        ...
        price: 150,
        image: { src: "/img/menu/kebabrull1.jpg", alt: "Biff i rull" }, // bytt når du har biff-bilde
      },
      {
        id: "grill-kebabtallerken",
        name: "Kebabtallerken",
        description: "Kebabtallerken med tilbehør",
        price: 160,
        image: {
      ...
      },
      {
        ...
        description: "Kyllingtallerken med tilbehør",
        price: 170,
        image: {
          src: "/img/menu/kebab_tallerken1.jpg",
          alt: "Kyllingtallerken",
        }, // bytt når du har kylling-tallerken bilde
      },
      {
        id: "grill-lovstektallerken",
        name: "Løvstektallerken",
        description: "Løvstektallerken med tilbehør",
        price: 170,
        image: {
          src: "/img/menu/kebab_tallerken1.jpg",
          alt: "Løvstektallerken",
        }, // bytt når du har løvstek-bilde
      },
      {
        id: "grill-biffsnadder",
        name: "Biffsnadder",
        description: "Biffsnadder med tilbehør",
        price: 190,
        image: {
          src: "/img/menu/kebab_tallerken1.jpg",
          alt: "Biffsnadder",
        }, // bytt når du har biffsnadder-bilde
      },
      {
        id: "grill-namnam-spesial",
        name: "Nam Nam spesial",
        description: "Kebabkjøtt, ost, pomfri, pitabrød",
        price: 170,
        featured: true,
  ...
  },
  {
    ...
    items: [
      ...
      // ... resten kan du fylle ut samme måte (du trenger ikke bilder på alt)
      ...
      { id: "pizza-kjottdeig-pepperoni", name: "Kjøttdeig, pepperoni, skinke og løk", description: "Kjøttdeig, pepperoni, skinke og løk", price: 180, priceLiten: 180, priceStor: 270 } as PizzaMenuItem,
      {
        ...
        name: "Kebabkjøtt, løk, mais, salattopping og kebabdressing",
        description: "Kebabkjøtt, løk, mais, salattopping og kebabdressing",
        price: 180,
        priceLiten: 180,
        priceStor: 270,
