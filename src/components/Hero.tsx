        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              {/* TODO: Replace href with your primary CTA destination */}
              <a
                href="#"
                rel="noopener"
              ...
              {/* TODO: Replace href with your secondary CTA destination */}
              <a
                href="#"
                rel="noopener"
                ...
                <span>[HERO_CTA_SECONDARY_LABEL]</span>
              </a>
            </div>
          </div>
        </div>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            {/* TODO: Update trust badge number and label */}
            Trusted by <span className="text-indigo-600">[TRUST_BADGE_NUMBER]+</span>{" "}
            [TRUST_BADGE_LABEL]
          </div>

          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
            {/* TODO: Replace these with your own partner/client logos */}
...
/* TODO: Replace BrandLogo1–5 SVG paths with your own partner/client logos */
function BrandLogo1() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
